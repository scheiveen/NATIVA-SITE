        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-[#BDB1A3] text-sm leading-relaxed max-w-md">
              ...
              produtor que busca excelência. Genética adaptada, origem
              controlada e rastreabilidade completa.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3 text-[#BDB1A3] text-sm">
                ...
                />
                <span>
                  Rua Padre Cristovão Arnald, 289 -
                  <br />
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
          <p className="text-[#BDB1A3] text-xs">
            ...
            <span className="text-[#C5A059]">
              NATIVA SEMENTES DE CEBOLA LTDA
            </span>
