  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Sementes de cebola com <span className="text-[#C5A059] font-semibold">pureza genética</span>, 
          <span className="text-[#C5A059] font-semibold"> sanidade</span>, 
          <span className="text-[#C5A059] font-semibold"> vigor germinativo</span> e 
          <span className="text-[#C5A059] font-semibold"> adaptação regional</span>. 
